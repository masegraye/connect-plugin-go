...
const (
	...
	HealthServiceName = "connectplugin.health.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/connectplugin.health.v1.HealthService/Check"
	// HealthServiceWatchProcedure is the fully-qualified name of the HealthService's Watch RPC.
	HealthServiceWatchProcedure = "/connectplugin.health.v1.HealthService/Watch"
)

// HealthServiceClient is a client for the connectplugin.health.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the connectplugin.health.v1.HealthService service.
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_plugin_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls connectplugin.health.v1.HealthService.Check.
...
// Watch calls connectplugin.health.v1.HealthService.Watch.
...
// HealthServiceHandler is an implementation of the connectplugin.health.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/connectplugin.health.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("connectplugin.health.v1.HealthService.Check is not implemented"))
}
...
func (UnimplementedHealthServiceHandler) Watch(context.Context, *connect.Request[v1.HealthCheckRequest], *connect.ServerStream[v1.HealthCheckResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("connectplugin.health.v1.HealthService.Watch is not implemented"))
}
